...
function Admin() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0f18] text-slate-100 font-sans">
      {/* ================= SIDEBAR ================= */}
      <aside className="hidden lg:flex fixed left-0 top-0 bottom-0 w-64 bg-[#131625] border-r border-slate-800 flex-col z-20">
        {/* Logo */}
        ...
        <nav className="flex-1 p-4 space-y-6">
          <div>
            ...
            <div className="space-y-1">
              <button className="w-full flex items-center gap-3 px-3 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium shadow-lg shadow-purple-600/20">
                <span>▦</span> Dashboard
              </button>
